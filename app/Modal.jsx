    ...
    async function checkout() {
        ...
        return (
            <div className='fixed top-0 left-0 w-screen h-screen z-50'>
                ...
                <div className='flex flex-col bg-white absolute right-0 top-0 h-screen shadow w-screen
                 sm:w-96 max-w-screen gap-4  p-4'>
                        <div className='flex items-center justify-between text-xl relative'>
                            <h1>Cart</h1>
                            <i onClick={closeModal}  className='fa-solid cursor-pointer hover:opacity-10 fa-xmark'></i>
                        ...
                        <div className='p-4 flex flex-col flex-1 gap-4 overflow-scroll'>
                            {cartItems.length === 0 ? (
                                ...
                                {cartItems.map((cartItem , itemIndex) => {
                                    return (
                                        <div key={itemIndex} className="flex flex-col gap-2 px-2 border-l border-solid border-slate-700 text-sm">
